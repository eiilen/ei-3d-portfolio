...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID,
      {
        ...
        to_email: 'smolbean.ei@gmail.com',
  ...
  return (
    <section className="relative flex lg:flex-row flex-col max-container">
      ...
      <div className="flex-1 min-w-[50%] flex flex-col">
        ...
        >
          ...
          <label className="text-black-500 font-semibold">
            Email
            <input 
              type="email" name="email" className="input" placeholder="jonh@email.com"
      ...
      <div className="ld:w/12 w-full lg:h-auto md:h-[550px] h-[350px]">
        <Canvas
          camera={{
            position: [0, 0, 5],
            fov: 75,
